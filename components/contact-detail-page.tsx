  ...
  const contactInfo = [
    {
      ...
      content: (
        <div className="space-y-2">
          <p className="font-semibold text-gray-900 dark:text-white">Finčevec 9</p>
          <p className="text-gray-600 dark:text-gray-300">48260 Sveti Petar Orehovec</p>
    ...
    },
    {
      ...
      content: (
        <div className="space-y-2">
          <p className="font-semibold text-gray-900 dark:text-white">+385 95 842 7667</p>
          <p className="text-sm text-gray-600 dark:text-gray-300">{t("availableDuringWorkingHours")}</p>
        </div>
      ),
      action: {
        label: t("callNow"),
    ...
    },
    {
      ...
      content: (
        <div className="space-y-2">
          <p className="font-semibold text-gray-900 dark:text-white">autoserviskatanovic@gmail.com</p>
          <p className="text-sm text-gray-600 dark:text-gray-300">{t("emailResponse")}</p>
        </div>
      ),
      action: {
        label: t("sendEmail"),
      ...
      content: (
        <div className="space-y-2">
          ...
          <div className="flex justify-between">
            ...
            <span className="font-semibold text-gray-900 dark:text-white">08:00 - 14:00</span>
          </div>
          <div className="flex justify-between">
      ...
      <section className="py-16 md:py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-white mb-4">{t("quickContact")}</h2>
            <p className="text-lg text-gray-600 dark:text-gray-300">{t("chooseContactMethod")}</p>
          </div>
      ...
      <section className="py-16 md:py-20 bg-gray-50 dark:bg-gray-800/50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-6">{t("contactInfo")}</h2>
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">{t("contactInfoDesc")}</p>
          </div>
                ...
                <Card key={index} className="bg-white dark:bg-gray-800 border-0 shadow-lg">
                  <CardContent className="p-8">
                    <div className="text-center mb-6">
                      ...
                      <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">{info.title}</h3>
                    </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16">
            ...
            <div>
              <div className="mb-8">
                ...
                <p className="text-lg text-gray-600 dark:text-gray-300">{t("fillFormBelow")}</p>
              </div>
              ...
              <Card className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-lg">
                ...
                <CardContent>
                  <form id="contact-form" action={handleSubmit} className="space-y-6">
                    ...
                    {submitStatus === "success" && (
                      <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg p-4">
                        <div className="flex items-center space-x-2">
                          ...
                          <p className="text-green-800 dark:text-green-200 font-medium">{t("messageSuccess")}</p>
                        </div>
                      </div>
                    )}
                    ...
                    {submitStatus === "error" && (
                      <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg p-4">
                        <div className="flex items-center space-x-2">
                          ...
                          <p className="text-red-800 dark:text-red-200 font-medium">{t("messageError")}</p>
                        </div>
                      </div>
                    )}
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400 text-center">{t("requiredFields")}</p>
                  </form>
                </CardContent>
              </Card>
            </div>
            ...
            <div>
              <div className="mb-8">
                ...
                <p className="text-lg text-gray-600 dark:text-gray-300">{t("findUsDesc")}</p>
              </div>
          ...
          <Card className="bg-gradient-to-r from-blue-600 to-blue-700 dark:from-blue-500 dark:to-blue-600 border-0 rounded-3xl overflow-hidden shadow-xl max-w-4xl mx-auto">
            <CardContent className="p-8 md:p-16 text-center">
              <div className="space-y-8">
                <h2 className="text-3xl md:text-4xl font-bold text-white leading-tight">{t("needUrgentHelp")}</h2>
                <p className="text-xl text-blue-100 leading-relaxed max-w-2xl mx-auto">{t("urgentHelpDesc")}</p>
