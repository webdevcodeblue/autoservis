...
export function ContactSection() {
  ...
  return (
    <section id="contact" className="py-12 sm:py-16 md:py-20 relative overflow-hidden">
      ...
      <div ref={ref} className="container mx-auto px-1 xs:px-2 sm:px-4 md:px-6 relative z-10">
        <div className={`text-center mb-8 sm:mb-12 md:mb-16 animate-fade-in ${inView ? "visible" : ""}`}>
        ...
        <div className="grid lg:grid-cols-3 gap-3 sm:gap-4 md:gap-6 lg:gap-8">
          ...
          <div className="lg:col-span-1 space-y-4 sm:space-y-5 md:space-y-6">
            {[
              ...
              return (
                <Card
                  key={index}
                  className={`bg-white/80 dark:bg-gray-800/80 border-white/20 dark:border-gray-700/20 card-hover animate-fade-in ${inView ? "visible" : ""}`}
          ...
          <div className="lg:col-span-2 space-y-4 sm:space-y-6 md:space-y-8">
            {/* Contact Form */}
            <Card
              className={`bg-white/90 dark:bg-gray-800/90 border-white/20 dark:border-gray-700/20 animate-fade-in ${inView ? "visible" : ""}`}
              style={{ transitionDelay: "400ms" }}
            >
              <CardHeader className="p-4 sm:p-5 md:p-6">
                <CardTitle className="text-gray-900 dark:text-white text-lg sm:text-xl">{t("contactForm")}</CardTitle>
              </CardHeader>
              <CardContent className="p-5 sm:p-6 md:p-7">
                <form id="contact-form" action={handleSubmit} className="space-y-5 sm:space-y-6">
            ...
            >
              <CardHeader className="p-4 sm:p-5 md:p-6">
                <CardTitle className="text-gray-900 dark:text-white text-lg sm:text-xl">{t("findUs")}</CardTitle>
              </CardHeader>
