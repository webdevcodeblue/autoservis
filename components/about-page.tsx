...
export function AboutPage() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          <div className="space-y-8">
            <div className="space-y-6">
              ...
              <p className="text-lg text-gray-600 dark:text-gray-300 leading-relaxed">{t("ourStoryDescription1")}</p>
              <p className="text-lg text-gray-600 dark:text-gray-300 leading-relaxed">{t("ourStoryDescription2")}</p>
            </div>
      ...
      <div className="bg-gray-50 dark:bg-gray-800/50 py-16 md:py-24">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-6">{t("ourValuesTitle")}</h2>
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">{t("ourValuesDescription")}</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {values.map((value, index) => {
              ...
              return (
                <Card key={index} className="bg-white dark:bg-gray-800 border-0 rounded-2xl shadow-md">
      ...
      <div className="container mx-auto px-4 py-16 md:py-24">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-6">{t("ourJourneyTitle")}</h2>
          <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">{t("ourJourneyDescription")}</p>
        </div>
              ...
              <div key={index} className="flex flex-col md:flex-row gap-6 md:gap-8">
                ...
                <Card className="flex-1 bg-white dark:bg-gray-800 border-0 rounded-2xl shadow-md">
                  <CardContent className="p-8">
                    ...
                    <p className="text-lg text-gray-600 dark:text-gray-300 leading-relaxed">{milestone.description}</p>
                  </CardContent>
                </Card>
              </div>
            ))}
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <div className="space-y-8">
              <div className="space-y-6">
                ...
                <p className="text-lg text-gray-600 dark:text-gray-300 leading-relaxed">{t("expertiseDescription")}</p>
              </div>
              ...
              <div className="space-y-4">
                {certifications.map((cert, index) => (
                  <div key={index} className="flex items-center space-x-4">
                    ...
                    <span className="text-lg text-gray-700 dark:text-gray-300">{cert}</span>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-6">
              <Card className="bg-white dark:bg-gray-800 border-0 rounded-2xl shadow-md">
                <CardContent className="p-6 text-center">
                  ...
                  <div className="text-2xl font-bold text-gray-900 dark:text-white mb-2">4.9/5</div>
              ...
              <Card className="bg-white dark:bg-gray-800 border-0 rounded-2xl shadow-md">
                <CardContent className="p-6 text-center">
                  ...
                  <div className="text-sm text-gray-600 dark:text-gray-300">{t("averageServiceTime")}</div>
                </CardContent>
              </Card>
              ...
              <Card className="bg-white dark:bg-gray-800 border-0 rounded-2xl shadow-md col-span-2">
                <CardContent className="p-6 text-center">
                  ...
                  <div className="text-2xl font-bold text-gray-900 dark:text-white mb-2">{t("warranty")}</div>
                  <div className="text-sm text-gray-600 dark:text-gray-300">{t("warrantyDescription")}</div>
                </CardContent>
              </Card>
            </div>
          </div>
        ...
        <Card className="bg-gradient-to-r from-blue-600 to-blue-700 dark:from-blue-500 dark:to-blue-600 border-0 rounded-3xl overflow-hidden shadow-xl">
          <CardContent className="p-8 md:p-16 text-center">
            <div className="max-w-3xl mx-auto space-y-8">
              <h2 className="text-3xl md:text-4xl font-bold text-white leading-tight">{t("joinOurStoryTitle")}</h2>
              <p className="text-xl text-blue-100 leading-relaxed">{t("joinOurStoryDescription")}</p>
