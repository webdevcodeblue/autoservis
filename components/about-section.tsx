    ...
    <section id="about" className="py-20 relative overflow-hidden">
      ...
      <div ref={ref} className="container mx-auto px-4 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="grid sm:grid-cols-2 gap-4 md:gap-6">
              {features.map((feature, index) => {
                ...
                return (
                  <div
                    key={index}
                    className={`flex items-start space-x-4 bg-white/60 dark:bg-gray-800/60 p-4 rounded-lg border border-white/20 dark:border-gray-700/20 animate-fade-in ${inView ? "visible" : ""}`}
          ...
          {/* Right Column - Image */}
          <div className={`relative animate-fade-in ${inView ? "visible" : ""}`} style={{ transitionDelay: "200ms" }}>
