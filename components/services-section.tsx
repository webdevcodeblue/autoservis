...
export function ServicesSection() {
  ...
  return (
    <section
      id="services"
      className="section-padding relative overflow-hidden smooth-scroll"
    >
        ...
        <div className="hidden md:grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {services.map((service, index) => {
            ...
            return (
              <Card
                key={index}
                className={`bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 card-hover animate-fade-in gpu-acceleration ${
                  inView ? 'visible' : ''
                }`}
